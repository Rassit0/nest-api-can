...
-- CreateEnum
CREATE TYPE "PlayerPassStatus" AS ENUM ('PENDING', 'ACTIVE', 'CATEGORY_EXPIRED', 'INACTIVE', 'REJECTED');
...
CREATE TABLE "team_seasons" (
    ...
    "suspension_after_months_due" INTEGER NOT NULL DEFAULT 2,
...
CREATE TABLE "player_passes" (
    ...
    "external_previous_team_name" TEXT,
    "origin_type" "PassOriginType" NOT NULL,
    "previous_team_source" "PreviousTeamSource" NOT NULL,
    "status" "PlayerPassStatus" NOT NULL DEFAULT 'PENDING',
    "external_next_team_name" TEXT,
    "start_date" TIMESTAMP(3) NOT NULL,
    "end_date" TIMESTAMP(3),
    "notes" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
