...
CREATE TABLE "club_offerings" (
    ...
    CONSTRAINT "club_offerings_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "team_offerings" (
    "id" TEXT NOT NULL,
    "team_id" TEXT NOT NULL,
    "club_offering_id" TEXT NOT NULL,
    ...
    CONSTRAINT "team_offerings_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "club_offerings" ADD CONSTRAINT "club_offerings_season_id_fkey" FOREIGN KEY ("season_id") REFERENCES "seasons"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "club_offerings" ADD CONSTRAINT "club_offerings_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "clubs"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "team_offerings" ADD CONSTRAINT "team_offerings_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "team_offerings" ADD CONSTRAINT "team_offerings_club_offering_id_fkey" FOREIGN KEY ("club_offering_id") REFERENCES "club_offerings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "team_memberships" ADD CONSTRAINT "team_memberships_team_offering_id_fkey" FOREIGN KEY ("team_offering_id") REFERENCES "team_offerings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "player_reinforcements" ADD CONSTRAINT "player_reinforcements_team_offering_id_fkey" FOREIGN KEY ("team_offering_id") REFERENCES "team_offerings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "player_pass_offerings" ADD CONSTRAINT "player_pass_offerings_team_offering_id_fkey" FOREIGN KEY ("team_offering_id") REFERENCES "team_offerings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "course_offerings" ADD CONSTRAINT "course_offerings_season_id_fkey" FOREIGN KEY ("season_id") REFERENCES "seasons"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "course_enrollments" ADD CONSTRAINT "course_enrollments_course_offering_id_fkey" FOREIGN KEY ("course_offering_id") REFERENCES "course_offerings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
