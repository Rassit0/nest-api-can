...
describe('MembershipCyclesEngine', () => {
  ...
  it('should generate all valid cycles for a standard season', () => {
    ...
    expect(lastCycle.nextDueDate.getTime()).toBeGreaterThan(membership.teamSeason.season.endDate.getTime());
  });
  ...
  it('should appropriately end generation after season end date', () => {
    ...
    membership.teamSeason.season.endDate = new Date(Date.UTC(2024, 2, 31, 23, 59, 59, 999));
