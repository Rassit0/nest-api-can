...
// 1. Remove old MatchLineup
schema = schema.replace(/model MatchLineup \{[\s\S]*?@@map\("match_lineups"\)\n\}\n/g, '');

// 2. Add MatchSide enum
if (!schema.includes('enum MatchSide')) {
  schema += '\n\nenum MatchSide {\n  HOME\n  AWAY\n}\n';
}

// 3. Add MatchCallUp and MatchLineup
const newModels = `
model MatchCallUp {
